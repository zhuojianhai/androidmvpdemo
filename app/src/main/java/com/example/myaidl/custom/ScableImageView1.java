...
public class ScableImageView1 extends View implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public ScableImageView1(Context context) {
        super(context);
    }

    public ScableImageView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float sacle = big?bigScale:smallScale;
